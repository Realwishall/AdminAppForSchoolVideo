...
public class AdapterLecture3 extends RecyclerView.Adapter<AdapterLecture3.BatchViewHolder> {
    ...
    public AdapterLecture3(Context mCtx, List<ListLectureList> batchtlist) {
        this.mCtx = mCtx;
